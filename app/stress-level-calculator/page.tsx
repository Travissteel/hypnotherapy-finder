  ...
  const calculateStress = () => {
    ...
    if (score < 15) {
      setResult({
        ...
        score,
        recommendation:
          'Your stress levels are manageable. Continue practicing self-care and maintaining healthy boundaries. Hypnotherapy can be a great preventive tool to build resilience.',
        cta: false,
      });
    } else if (score < 25) {
      setResult({
        ...
        <section className="relative pt-16 pb-12 overflow-hidden bg-gradient-to-br from-purple-100 via-blue-100 to-teal-100">
          ...
          <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center relative z-10">
            ...
            <p className="text-xl text-gray-700 font-medium max-w-2xl mx-auto">
              Answer five quick questions to get a personalised stress assessment and find out if hypnotherapy could help.
            </p>
          </div>
        </section>
