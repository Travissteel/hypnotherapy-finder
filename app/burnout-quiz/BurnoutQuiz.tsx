...
const questions = [
  { id: 1, category: 'Emotional Exhaustion', text: 'Do you feel emotionally drained or depleted at the end of a working day?' },
  { id: 2, category: 'Emotional Exhaustion', text: 'Do you feel used up — like you have nothing left to give — by the end of the week?' },
  { id: 3, category: 'Emotional Exhaustion', text: 'Do you feel frustrated, irritable, or resentful about your work or responsibilities more than you used to?' },
  { id: 4, category: 'Detachment & Cynicism', text: 'Have you become more cynical or indifferent about your job, colleagues, or the people you serve?' },
  { id: 5, category: 'Detachment & Cynicism', text: 'Do you feel emotionally detached or numb when you used to feel engaged or passionate?' },
  { id: 6, category: 'Detachment & Cynicism', text: 'Do you find yourself going through the motions at work, just trying to get through the day?' },
  { id: 7, category: 'Reduced Effectiveness', text: 'Do you feel like your work quality or productivity has declined, even when you are putting in effort?' },
  { id: 8, category: 'Reduced Effectiveness', text: 'Do you feel like nothing you do at work makes a real difference or is appreciated?' },
  { id: 9, category: 'Reduced Effectiveness', text: 'Do you struggle to concentrate, make decisions, or stay motivated during work tasks?' },
  { id: 10, category: 'Physical Symptoms', text: 'Do you experience physical symptoms such as headaches, sleep problems, or frequent illness that may be linked to work stress?' },
  { id: 11, category: 'Physical Symptoms', text: 'Do you feel physically exhausted even after time off or a full night of sleep?' },
  { id: 12, category: 'Work-Life Balance', text: 'Has work stress begun to affect your personal relationships, hobbies, or life outside of work?' },
  { id: 13, category: 'Work-Life Balance', text: 'Do you feel unable to properly switch off from work, even during evenings or weekends?' },
];
...
export default function BurnoutQuiz() {
  ...
  const calculate = () => {
    ...
    if (pct < 25) {
      setResult({ headline: 'Low Burnout Risk', body: 'Your responses suggest you are managing your workload relatively well right now. Keep an eye on the warning signs — burnout tends to creep up gradually. Hypnotherapy can be a great preventive tool for building resilience and stress management.', severity: 'low' });
    } else if (pct < 55) {
      setResult({ headline: 'Moderate Burnout', body: 'Your responses suggest you are experiencing significant signs of burnout. This is your mind and body signalling that something needs to change. Hypnotherapy can help by addressing the deep-rooted stress patterns, rebuilding motivation, and helping you establish healthier boundaries.', severity: 'moderate' });
    } else {
      setResult({ headline: 'Severe Burnout', body: 'Your responses suggest severe burnout that is significantly affecting your health, work, and personal life. Burnout at this level is serious — please do not ignore it. Hypnotherapy combined with lifestyle changes can be powerfully effective at helping you recover and reconnect with a sense of purpose.', severity: 'high' });
    }
  };
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {result.severity !== 'low' && (
            <div className="glass-card" style={{ padding: 24, borderLeft: '3px solid var(--hf-accent)' }}>
              <h3 style={{ fontWeight: 700, color: 'var(--hf-fg)', marginBottom: 8 }}>How Hypnotherapy Helps Burnout</h3>
