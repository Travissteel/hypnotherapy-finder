...
const questions = [
  { id: 1, category: 'Saying No', text: 'Do you find it very difficult to say no to requests, even when you are already overwhelmed?' },
  { id: 2, category: 'Saying No', text: 'Do you agree to things you do not want to do in order to avoid conflict or disappointing others?' },
  { id: 3, category: 'Saying No', text: 'Do you feel guilty or anxious after saying no to someone, even when the request was unreasonable?' },
  { id: 4, category: 'Approval Seeking', text: 'Do you feel anxious or unsettled when you sense that someone is unhappy with you?' },
  { id: 5, category: 'Approval Seeking', text: 'Do you change your opinions or behaviour depending on who you are with, in order to fit in or be liked?' },
  { id: 6, category: 'Approval Seeking', text: 'Do you seek frequent reassurance or validation from others that you have done the right thing?' },
  { id: 7, category: 'Putting Others First', text: "Do you consistently prioritise other people's needs over your own, even to your own detriment?" },
  { id: 8, category: 'Putting Others First', text: "Do you feel responsible for managing other people's feelings or making sure everyone around you is happy?" },
  { id: 9, category: 'Putting Others First', text: 'Do you apologise excessively — even for things that are not your fault?' },
  { id: 10, category: 'Resentment & Burnout', text: 'Do you feel resentful or taken advantage of, but continue to say yes anyway?' },
  { id: 11, category: 'Resentment & Burnout', text: 'Do you feel exhausted by always trying to keep others happy while suppressing your own needs?' },
  { id: 12, category: 'Identity & Boundaries', text: 'Do you struggle to identify what you actually want, feel, or need — separate from what others expect of you?' },
];
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {result.severity !== 'low' && (
            <div className="glass-card" style={{ padding: 24, borderLeft: '3px solid var(--hf-accent)' }}>
              <h3 style={{ fontWeight: 700, color: 'var(--hf-fg)', marginBottom: 8 }}>How Hypnotherapy Helps People Pleasers</h3>
