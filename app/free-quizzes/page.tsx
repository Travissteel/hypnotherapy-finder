...
const quizzes = [
  ...
  { href: '/social-anxiety-test', icon: Users2, hue: 300, title: 'Social Anxiety Test', desc: 'Check social fear, judgement worries, avoidance, and post-event rumination.', volume: '5.7k searches/month' },
  ...
  { href: '/anxiety-quiz', icon: HeartPulse, hue: 185, title: 'Anxiety Quiz', desc: 'Check worry, body tension, avoidance, sleep disruption, and daily impact.', volume: '2.2k searches/month' },
  ...
  { href: '/anger-test', icon: Angry, hue: 10, title: 'Anger Test', desc: 'Check anger patterns across 6 dimensions including suppression and hostility.', volume: '7.2k searches/month' },
  { href: '/insomnia-test', icon: Moon, hue: 240, title: 'Insomnia Test', desc: 'Check sleep problems, night waking, racing thoughts, and daily impact.', volume: '3.45k searches/month' },
  { href: '/self-esteem-test', icon: Star, hue: 60, title: 'Self-Esteem Test', desc: 'Check self-worth, criticism, confidence, comparison, and inner dialogue.', volume: '1.45k searches/month' },
